package com.microserviceproject.services.client.dto;
...
/**
 * DTO object used to transfer data outside the client object.
 */
public class DTOClient {
    ...
    public DTOClient(Integer ID, String firstName, String surname, Integer phoneNumber, LocalDate lastUpdated, LocalDate creationDate, ContactBy contactBy, String email) {
        this.ID = ID;
        this.firstName = firstName;
        this.surname = surname;
        this.phoneNumber = phoneNumber;
