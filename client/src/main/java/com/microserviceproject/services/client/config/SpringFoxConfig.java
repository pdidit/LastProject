package com.microserviceproject.services.client.config;
...
/**
 * Configuration for the swagger api
 */
@Configuration
public class SpringFoxConfig {
    ...
    public static final ApiInfo CUSTOM_API_INFO = new ApiInfoBuilder().title("Padraic Custom API")
            .description("customer descriptions here").version("1.0").contact(CUSTOM_CONTACT).build();
